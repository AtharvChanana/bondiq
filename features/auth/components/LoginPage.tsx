      ...
      >
        ...
        <div>
          ...
          <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '18px', fontStyle: 'italic', color: '#000000', fontWeight: 600, lineHeight: 1.5 }}>
            Your AI-powered memory for every person that matters.
          </p>
        </div>

        {/* Bottom tag */}
        <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
          {['MEMORIES', 'GOALS', 'AI CHAT', 'NUDGES'].map(tag => (
            <div key={tag} style={{ fontFamily: "'Space Mono', monospace", fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', background: '#000000', color: '#FFFFFF', padding: '4px 10px', border: '2px solid #000000' }}>
              {tag}
            </div>
          ))}
        </div>
